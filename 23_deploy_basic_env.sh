...
init_vars() {
    ...
    UBUNTU_IP="192.168.1.248"
    UBUNTU_USER=root
    UBUNTU_PASSWORD=logon1vm
    UBUNTU_PRIMARY_STORAGE="nfs://192.168.1.248/data/ubuntu_primary"
    UBUNTU_SECONDARY_STORAGE="nfs://192.168.1.248/data/ubuntu_secondary"

    MAINFRAME_IP=204.90.115.208
    MAINFRAME_USER=root
    MAINFRAME_PASSWORD=logon1vm
    MAINFRAME_PRIMARY_STORAGE="nfs://204.90.115.208/data/mainframe_primary"
    MAINFRAME_SECONDARY_STORAGE="nfs://192.168.1.248/data/ubuntu_secondary"
...
create_zone() {
    ...
    do_cmd 'result=$(cmk create zone dns1=8.8.8.8 internaldns1=192.168.1.1 name='$zone_name' networktype=Basic)' "Zone created." "Zone creation failed."

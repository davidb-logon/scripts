...
virt-install --name deb11-a \
    ...
    --extra-args="auto=true priority=critical $parms1 preseed/url=http://localhost:8090/preseed_s390x.cfg DEBCONF_DEBUG=5 DEBIAN_FRONTEND=noninteractive auto-install/enable=true"

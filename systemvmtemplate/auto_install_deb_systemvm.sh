...
virt-install --name deb11-a \
    ...
    --extra-args="auto=true priority=critical s390-netdevice/choose_networktype=virtio preseed/file=/preseed_s390x.cfg DEBIAN_FRONTEND=noninteractive auto-install/enable=true" \

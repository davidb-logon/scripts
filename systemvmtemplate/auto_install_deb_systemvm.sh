...
virt-install --name deb11-a \
    ...
    --extra-args="priority=critical s390-netdevice/choose_networktype=virtio $parms1 $parms2 $parms3 preseed/file=/preseed_s390x.cfg DEBCONF_DEBUG=5 DEBIAN_FRONTEND=noninteractive auto-install/enable=true" \

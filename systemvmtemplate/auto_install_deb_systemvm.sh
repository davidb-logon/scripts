...
virt-install --name deb11-a \
    ...
    --extra-args="auto=true priority=critical s390-netdevice/choose_networktype=virtio file=/preseed_s390x.cfg DEBCONF_DEBUG=5 DEBIAN_FRONTEND=noninteractive auto-install/enable=true" \

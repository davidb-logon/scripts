...
virt-install --name deb11-b \
    ...
    --extra-args="auto=true priority=critical net.ifnames=0 biosdevname=0 preseed/file=/preseed_simple.cfg s390-netdevice/choose_networktype=virtio DEBCONF_DEBUG=5 DEBIAN_FRONTEND=noninteractive auto-install/enable=true interface=eth0 BOOTIF=01-52-54-00-52-0a-b8"

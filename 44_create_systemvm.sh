...
virt-install --name debian10-1 --memory 2048 --vcpus=2  --os-variant=debian10  --network network=default --graphics=none -v --disk path=/data/primary/vm/images/debiaen108-1.qcow2,size=6 --check disk_size=off --boot hd --location=/data/vm/debian-10.8.0-s390x-xfce-CD-1.iso
